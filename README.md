...
run the "make run_docker" command again.

Once it's available, access it through the browser at [localhost:3000](localhost:3000).
...
4) Activate the "Algo Trading" button at the top of MetaTrader.
5) Activate the expert in any symbol chart (e.g. USCAD, M5), it does not matter which chart you use. 
